...
# New weight include bg pixel
#WEIGHTS = np.array([1, 4, 4, 16, 8, 4, 1, 8, 2, 16, 4, 4, 4, 4, 2, 2, 32, 1, 4, 2, 8, 2, 1, 2, 2, 2, 2, 8, 1, 4, 8, 8, 1, 2])

# Big Weight for BG pixel
#WEIGHTS = np.array([16, 4, 4, 16, 8, 4, 1, 8, 2, 16, 4, 4, 4, 4, 2, 2, 16, 1, 4, 2, 8, 2, 1, 2, 2, 1, 2, 4, 1, 4, 8, 8, 1, 2])
WEIGHTS = np.array([16, 4, 4, 16, 8, 4, 1, 8, 2, 16, 4, 4, 4, 4, 2, 2, 32, 1, 4, 2, 8, 2, 1, 2, 2, 2, 2, 8, 1, 4, 8, 8, 1, 2])
IMAGE_SIZE = 256
...
class SiftFlowData(Dataset):
  """Flowers data set."""

  def __init__(self, subset):
    super(SiftFlowData, self).__init__('SiftFlow', subset)
