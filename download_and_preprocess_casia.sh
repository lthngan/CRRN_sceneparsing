...
#
# usage:
#  ./download_and_preprocess_flowers.sh [data-dir] [src-dir]
set -e
...
# train directory.
#cp "${SRC_DIR}/casia_gray.zip" "${DATA_DIR}"
unzip "${SRC_DIR}/casia_gray.zip" -d "${DATA_DIR}"
rm -rf "${TRAIN_DIRECTORY}" "${VALIDATION_DIRECTORY}"
mv "${DATA_DIR}/casia_gray" "${TRAIN_DIRECTORY}"
