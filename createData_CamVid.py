...
# SiftFlow database
data_dir = '/media/ligong/Documents/Research/Stanford-TF/CamVid/701_StillsRaw_full'
label_dir = '/media/ligong/Documents/Research/Stanford-TF/CamVid/labels'
#imdb_path = 'imdb_siftflow_img_label.h5'
#create_imdb_siftflowEx(data_dir, label_dir, imdb_path)
resizeData(data_dir, label_dir, './CamVid/train', new_size=[256,256,3])
