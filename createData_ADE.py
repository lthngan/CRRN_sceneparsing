...
# SiftFlow database
data_dir = '/media/chinhan/dcnhan/data/Database/ADEChallengeData2016/images/validation'
label_dir = '/media/chinhan/dcnhan/data/Database/ADEChallengeData2016/annotations/validation'
#imdb_path = 'imdb_siftflow_img_label.h5'
#create_imdb_siftflowEx(data_dir, label_dir, imdb_path)
resizeData(data_dir, label_dir, './ADEChallenge/validation', new_size=[256,256,3])
